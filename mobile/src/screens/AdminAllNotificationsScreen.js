...
export default function AdminAllNotificationsScreen({ route, navigation }) {const { theme, isDarkMode } = useTheme();
  ...
  const fetchNotifications = async () => {
    setLoading(true);
    try {
      const res = await axios.get(`${API_URL}/notifications/all`, {
