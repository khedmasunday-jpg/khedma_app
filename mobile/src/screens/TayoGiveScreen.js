...
const getStyles = (theme, isDarkMode) => StyleSheet.create({
  ...
  modalContent: { backgroundColor: theme.cardBackground, padding: 25, borderTopLeftRadius: 25, borderTopRightRadius: 25, ...Platform.select({ ios: { shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.1, shadowRadius: 10 }, android: { elevation: 10 } }) },
